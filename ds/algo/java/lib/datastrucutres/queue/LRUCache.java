...
/**
 * A DoublyLinkedList containing key,value pairs A HashMap containing key to object values map Every
 * operation in O(1)
 *
 * @author tapopadma
 */
public class LRUCache {
  ...
  public void put(String key, Object value) {
    ...
    keyToValueMap.put(key, values.addFirst(new Entry(key, value)));
  }
}
